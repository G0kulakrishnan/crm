...
const NAV_ITEMS = [
  ...
  { id: 'distributor_performance', label: 'Performance', icon: 'M21 21H3V3h18v18z M9 17v-6 M12 17V9 M15 17v-4', permKey: 'distributors' }, // No strict separate perm key for now, handled generically or with 'Distributors'
  { group: 'Appointments' },
