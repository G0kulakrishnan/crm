...
const NAV_ITEMS = [
  ...
  { group: 'Partners' },
  { id: 'distributors', label: 'Distributors', icon: 'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M23 21v-2a4 4 0 0 0-3-3.87 M16 3.13a4 4 0 0 1 0 7.75 M7 10h14 M7 14h14 M7 18h14', permKey: 'distributors' }, // No strict separate perm key for now, handled generically or with 'Distributors'
  { group: 'Appointments' },
