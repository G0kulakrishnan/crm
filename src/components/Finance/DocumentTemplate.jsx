        ...
        <div className="spreadsheet-template" style={{ fontSize: '11px', lineHeight: '1.4', fontFamily: 'sans-serif' }}>
          ...
          <div style={{ border: '2px solid #000', minHeight: '280mm', display: 'flex', flexDirection: 'column', boxSizing: 'border-box' }}>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '0 20px' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #000', borderBottom: 'none' }}>
                <thead>
                  ...
                  <tr style={{ textAlign: 'center', backgroundColor: '#f9fafb', fontSize: '10px' }}>
                    <th style={{ width: '60px', padding: '4px' }}>%</th>
                    <th style={{ width: '60px', padding: '4px' }}>AMT</th>
                    <th style={{ width: '60px', padding: '4px' }}>%</th>
                    <th style={{ width: '60px', padding: '4px' }}>AMT</th>
                  </tr>
                </thead>
              ...
              {/* Filler space with vertical lines matching table columns */}
              <div style={{ flex: 1, display: 'flex', borderLeft: '1px solid #000', borderRight: '1px solid #000' }}>
                  <div style={{ width: '40px', borderRight: '1px solid #000', boxSizing: 'border-box' }}></div>
                  <div style={{ flex: 1, borderRight: '1px solid #000', boxSizing: 'border-box' }}></div>
                  <div style={{ width: '60px', borderRight: '1px solid #000', boxSizing: 'border-box' }}></div>
                  <div style={{ width: '90px', borderRight: '1px solid #000', boxSizing: 'border-box' }}></div>
                  <div style={{ width: '60px', borderRight: '1px solid #000', boxSizing: 'border-box' }}></div>
                  <div style={{ width: '60px', borderRight: '1px solid #000', boxSizing: 'border-box' }}></div>
                  <div style={{ width: '60px', borderRight: '1px solid #000', boxSizing: 'border-box' }}></div>
                  <div style={{ width: '60px', borderRight: '1px solid #000', boxSizing: 'border-box' }}></div>
                  <div style={{ width: '100px', boxSizing: 'border-box' }}></div>
              </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', margin: '10px 0', fontSize: '8px', opacity: 0.5 }}>
